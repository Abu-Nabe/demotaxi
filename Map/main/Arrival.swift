...
class Arrival: UIViewController{
    var username = ["Stephanie"]
    
    var message = ["Estimated Arrival"]
    
    var timeago = ["2minutes", "7min ago"]
...
extension Arrival: UITableViewDelegate, UITableViewDataSource
{
